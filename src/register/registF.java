...
public class registF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Premium Photo _ 3D render of Metaverse technology background with blockchain network connections.jpg"))); // NOI18N
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 210, 32));
        ...
        getContentPane().add(fn, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 110, 190, -1));
        getContentPane().add(ln, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 150, 190, -1));
        getContentPane().add(mail, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 180, 190, -1));
        getContentPane().add(us, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 210, 190, -1));

        ut.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "User", "Admin", " " }));
        getContentPane().add(ut, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 280, 190, -1));
        ...
        getContentPane().add(pw, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 250, 190, -1));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Premium Photo _ 3D render of Metaverse technology background with blockchain network connections.jpg"))); // NOI18N
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 420));
